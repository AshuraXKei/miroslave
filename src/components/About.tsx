        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative">
              <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-3xl bg-gradient-to-br from-amber-500 via-orange-500 to-rose-500 flex items-center justify-center shadow-2xl shadow-amber-500/20">
              ...
              <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-br from-rose-400 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg">
