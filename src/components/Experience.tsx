    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="relative">
          {/* Timeline line */}
          <div className="absolute left-4 sm:left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-amber-500 via-orange-500 to-rose-500 opacity-20" />
          ...
          <div className="space-y-8">
            {data.map((item, i) => {
              ...
              return (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-2 sm:left-6 top-8 w-4 h-4 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 border-4 border-white dark:border-gray-900 shadow-md z-10" />

                  <div className="group p-6 sm:p-8 rounded-3xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 hover:border-amber-200 dark:hover:border-amber-700/50 hover:shadow-xl hover:shadow-amber-500/5 transition-all">
