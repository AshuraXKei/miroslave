          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {projects.map((project, i) => (
              <motion.div
                ...
                className="group relative rounded-3xl bg-white dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-300 hover:-translate-y-2"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 flex flex-wrap gap-1.5">
                    ...
                    {project.technologies.length > 4 && (
                      <span className="px-2.5 py-1 rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 text-xs font-medium">
                        +{project.technologies.length - 4}
                      </span>
                    )}
                  </div>
