        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <button
              ...
              className="hidden md:flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-500 to-orange-600 text-white text-sm font-semibold rounded-xl hover:shadow-lg hover:shadow-amber-500/25 transition-all hover:-translate-y-0.5"
            >
              Связаться
            </button>
          ...
          >
            <div className="flex flex-col items-center justify-center h-full gap-2">
              ...
              <motion.button
                ...
                onClick={() => scrollTo("contact")}
                className="mt-4 px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold rounded-xl"
              >
                Связаться со мной
              </motion.button>
              <motion.button
